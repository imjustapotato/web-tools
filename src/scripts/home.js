...
const toolsData = {
  "schedule-plotter": {
    ...
    disabled: false,
    screenshots: [
      "./screenshots/schedule-plotter/visualizer.png",
      "./screenshots/schedule-plotter/visualizer-edit.png",
      "./screenshots/schedule-plotter/plotter.png",
      "./screenshots/schedule-plotter/plotter-new.png",
      "./screenshots/schedule-plotter/plotter-v2.3.1.png"
    ]
  },
  "portal-parser": {
    kicker: "Parser",
    ...
    disabled: false,
    screenshots: [
      "./screenshots/portal-parser/prereq.png",
      "./screenshots/portal-parser/prereq-tree.png",
      "./screenshots/portal-parser/mapping.png"
    ]
  },
  "active-page-utility": {
    kicker: "Extension",
    ...
    disabled: false,
    screenshots: [
      "./screenshots/active-page-utility/apu.png",
      "./screenshots/active-page-utility/APU-Home.png"
    ]
  },
  "companion-page": {
    kicker: "Extension",
    ...
    disabled: false,
    screenshots: [
      "./screenshots/companion/companion.png",
      "./screenshots/companion/companion-home.png"
    ]
  },
  "pka-toolkit": {
    ...
    launchDisabled: true,
    screenshots: [
      "./screenshots/tracer-toolkit/tracer-status.png",
      "./screenshots/tracer-toolkit/tracer-convert.png",
      "./screenshots/tracer-toolkit/tracer-inject.png",
      "./screenshots/tracer-toolkit/tracer-mod.png"
    ]
  }
};
